...
def main():
    ...
    while True:
        ...
        for i, beam in enumerate(mbeam):
            ...
            mbeam = [beam for beam in mbeam if (beam is not None) and (check_bound(beam.rct) == (True, True))]
        ...
        # bomb.update(screen)
        score.update(screen)
        for beam in mbeam:  # ビームのNoneチェック
            beam.update(screen) 
